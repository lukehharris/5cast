...
def build_ss(income, basic_expenses, debt_expenses, misc_expenses, debt_balances, cash_balances, rates):
    s = {}
    #for column indicies, 0 = today, 1 = 1 month from today,...,n=n months from today
    
    s = build_income_section(s, income)
 
    s = build_expense_section(s, basic_expenses, debt_expenses, misc_expenses)
    
    s = calculate_net_income(s)
    
    s = build_cash_section(s, cash_balances, rates)
    
    s = build_debt_section(s, debt_balances, rates)
